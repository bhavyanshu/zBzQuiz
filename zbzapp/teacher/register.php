...
<div class="grids">
   <div class="grid-6 grid grey">
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  name="hongkiat" id="hongkiat-form">
         <p>
            <label for="username">
         <p>Username:</p></label><input type="text" class="txtinput" name="username" id="username" /><br />
         <label for="password">
            <p>Password:</p>
         </label>
         <input type="password" class="txtinput" name="password" id="password" /><br />
         <label for="email">
            <p>Email Address:</p>
         </label>
         <input type="text" class="txtinput" name="email" id="email" /></p>
         <section id="buttons">
